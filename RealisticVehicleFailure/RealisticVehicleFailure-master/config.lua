...
repairCfg = {
	...
	fixMessages = {
		...
		"PLEASE HELP THEY HAVE ME HOSTAGE AND ARE MAKING ME WRI- it started right up",
		"You replaced the tail light",
		"You knocked on a door and asked if they have a book of mormon",
		"If you are reading this, please send me your credit card number and the 3 wacky digits on the back",
		"Fortnite is dead",
		"Fuck a thuglife",
